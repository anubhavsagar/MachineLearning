...
def classify(tree, data):
    ...
    for record in data:
        #print "getting Class for record: ", record
        classification.append(get_classification(record, tree))

    return classification

def create_decision_tree(values, data, attributes, target_attr, fitness_func, default):
    """
    ...
    # return that classification.
        ...
        for val in values[best]:
            ...
            subtree = create_decision_tree(values,
